# Contributing to prettier-plugin-ember-hbs-tag

Open source projects like `prettier-plugin-ember-hbs-tag` live on your words of encouragement and contribution. Please give feedback, report issues, or submit pull requests!
...
1. Fork and clone this repo.
    ...
    ```sh
    git clone git@github.com:<your-github-handle>/prettier-plugin-ember-hbs-tag.git
    ```

1. Change directory.

    ```sh
    cd prettier-plugin-ember-hbs-tag
    ```
...
1. [Create a tag](https://github.com/ijlee2/prettier-plugin-ember-hbs-tag/releases/new) and provide release notes. The tag name should match the package version (e.g. `0.1.2`).
